...
function FirmProfile({ firms, setFirms }) {
  ...
  // New state for history deletion confirmation
  ...
  // ---------------------------------------------------------
  // SUB-COMPONENT: Pause Contact Modal
  // ---------------------------------------------------------
  const PauseModal = () => {
  ...
  // ---------------------------------------------------------
  // SUB-COMPONENT: Add Activity Modal
  // ---------------------------------------------------------
  const AddActivityModal = () => {
    ...
    const handleSaveActivity = () => {
      if (activityData.desc.trim() !== '') {
        ...
        const updatedHistory = [...profileHistory, newActivity];
        const updatedFirms = firms.map(f => f.id === firm.id ? { ...f, history: updatedHistory } : f);
        setFirms(updatedFirms);
